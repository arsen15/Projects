      ...
      //The check box listener.
        ...
        myValueSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(final ChangeEvent theEvent) {
                ...
                myColorDisplayPanel.setBackground(new Color(source.getValue(), 0, 0));
                final int redInt = myValueSlider.getValue();
                myColor.setRed(redInt);
                myValueField.setText("" + redInt);
                if (redInt >= MAX_VALUE) {
                    myIncreaseButton.setEnabled(false);
                } else if (redInt <= LEAST_VALUE) {
