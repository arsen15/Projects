      ...
      //The check box listener.
        ...
        myValueSlider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(final ChangeEvent theEvent) {
                ...
                myColorDisplayPanel.setBackground(new Color(0, source.getValue(), 0));
                final int greenInt = myValueSlider.getValue();
                myColor.setGreen(greenInt);
                myValueField.setText("" + greenInt);
                if (greenInt >= MAX_VALUE) {
                    myIncreaseButton.setEnabled(false);
                } else if (greenInt <= LEAST_VALUE) {
                    myDecreaseButton.setEnabled(false);
                } else {
