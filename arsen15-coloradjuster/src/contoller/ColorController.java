...
public class ColorController extends JPanel implements PropertyChangeListener {
    ...
    public static void createAndShowGUI() {
        ...
        //TODO Add ColorPanel cop as an Observer to the Model here. 
        color.addPropertyChangeListener(model.PropertyChangeEnabledMutableColor.PROPERTY_COLOR,
                                       cop);
        color.addPropertyChangeListener(model.PropertyChangeEnabledMutableColor.PROPERTY_BLUE,
                                      cop);
        color.addPropertyChangeListener(model.PropertyChangeEnabledMutableColor.PROPERTY_GREEN,
                                      cop);
        color.addPropertyChangeListener(model.PropertyChangeEnabledMutableColor.PROPERTY_RED,
                                        cop);
